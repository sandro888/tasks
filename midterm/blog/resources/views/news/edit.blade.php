...
<body >
    <div class="container">
        ...
        <input class="form-control" type="hidden" name="id" value="{{$news->id}}">
            <label>Title:</label>
            <input required type="text" name="title" placeholder="title" class="form-control"  value="{{$news->title}}"/>
          
            <label>Stuff about you :</label>
        <textarea required name="description" id="" cols="10" rows="10"  class="form-control" placeholder="desc">{{ $news->description}}</textarea>
