                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row justify-content-end align-items-center">
                                            ...
                                            <div class="col-auto">
                                                @if (Route::has('login'))
                                                <div class="head-account-links">

                                                    @auth

                                                    <a href="{{ route('login') }}"
                                                        class="hal-login js-om-ajax-login js-om-ajax-login-login">
                                                        <svg role="image" class="icon-user-circled hal-icon">
                                                            <use
                                                                xlink:href="/themes/custom/omedia/images/icons.svg?qk2202#icon-user-circled">
                                                            </use>
                                                        </svg>
                                                        შესვლა
                                                    </a>
                                        ...
                                        <nav role="navigation" aria-labelledby="-menu">
                                            ...
                                            <nav class="main-menu clearfix">
                                                <ul class="submenu submenu-level-0 list-unstyled">
                                                    ...
                                                    <li
                                                        ...
                                                        <ul class="submenu submenu-level-1 list-unstyled">
                                                            <li
                                                                ...
                                                                <a href="/topic/georgian-basketball"
                                                                    class="link-level-1"
                                                            ...
                                                            <li
                                                                ...
                                                                <ul class="submenu submenu-level-2 list-unstyled">
                                                                    <li
                                                                        class="menu-item item-level-2 menu-path-topic-nba">
                                                    ...
                                                    <li
                                                        class="menu-item item-level-0 item--expanded menu-path-topic-rugby">
                                                        ...
                                                        <ul class="submenu submenu-level-1 list-unstyled">
                                                            <li
                                                                ...
                                                                <ul class="submenu submenu-level-2 list-unstyled">
                                                                    ...
                                                                    <li
                                                                        class="menu-item item-level-2 menu-path-topic-atp">
                                                                        <a href="/topic/atp" class="link-level-2"
                                                                            data-drupal-link-system-path="taxonomy/term/60">ATP</a>
                                                                    </li>
                                                                    <li
                                                                        class="menu-item item-level-2 menu-path-topic-wta">
                                                            ...
                                                            <li
                                                                ...
                                                                <ul class="submenu submenu-level-2 list-unstyled">
                                                                    <li
                                                                        class="menu-item item-level-2 menu-path-topic-judo">
                                                                        <a href="/topic/judo" class="link-level-2"
                                                                            data-drupal-link-system-path="taxonomy/term/66">ძიუდო</a>
                                                                    </li>
                                                                    <li
                                                                        class="menu-item item-level-2 menu-path-topic-mma">
                                                    ...
                                                    <li class="menu-item item-level-0 item--expanded menu-path-popcorn">
                                                        ...
                                                        <ul class="submenu submenu-level-1 list-unstyled">
                                                            ...
                                                            <li
                                                                class="menu-item item-level-1 menu-path-popcorn-pop-fun">
                                                                <a href="/popcorn/pop-fun" class="link-level-1"
                                                                    data-drupal-link-system-path="taxonomy/term/3057">ქვიზი</a>
                                                            </li>
                                                            <li
                                                                class="menu-item item-level-1 menu-path-popcorn-pop-blog">
                        ...
                        <div class="of-top clearfix">
                            <div class="container">
                                <div class="of-social text-center text-lg-left float-lg-left">
                                    ...
                                    <a href="https://www.facebook.com/popsportcom/" target="_blank"
                                        class="boxed-icon"><svg role="image" class="icon-facebook-f bi-icon">
                                            <use
                                                xlink:href="/themes/custom/omedia/images/icons.svg?qk24s1#icon-facebook-f">
                                            </use>
                                        </svg></a>
                                    ...
                                    <a href="https://www.youtube.com/user/europebet" target="_blank"
                                        class="boxed-icon"><svg role="image" class="icon-youtube-play bi-icon">
                                            <use
                        ...
                        <div class="of-bottom clearfix">
                            <div class="container">
                                ...
                                <div class="of-omedia float-lg-right">
                                    <a href="http://omedia.ge"
                                        title="საიტების და მობილური აპლიკაციების დამზადება">შექმნილია ომედიაში</a>
                                </div>
                            </div>
                        </div>
                    </footer>
