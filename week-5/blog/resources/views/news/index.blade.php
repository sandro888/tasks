...
<div id="main-wrapper">
                ...
                <div class="col-md-7">
                    <div class="feature_article_wrapper">
                        ...
                        <div class="feature_article_inner">
                            ...
                            <div class="feature_article_date"><a href="#" target="_self">{{$data->latest('created_at')->first()->created_at}}}</a></div>
                            <!-- feature_article_date -->
    
                            <div class="feature_article_content">
                                {{$data->latest('created_at')->first()->description}}                            </div>
                    ...
                    <div class="feature_static_wrapper">
                        ...
                        <div class="feature_article_inner">
                            ...
                            <div class="feature_article_date"><a href="#"
                                                                                                             target="_self">
                                                                                                             {{$data->orderBy('created_at', 'desc')->skip(1)->take(1)->get()->first()->created_at}}</a></div>
                            <!-- feature_article_date -->
    
                            <div class="feature_article_content">
                                {{$data->orderBy('created_at', 'desc')->skip(1)->take(1)->get()->first()->description}}
                            </div>
                            <!-- feature_article_content -->
                    ...
                    <div class="feature_static_last_wrapper">
                        ...
                        <div class="feature_article_inner">
                            ...
                            <div class="feature_article_date"><a href="#" target="_self"></a>
                                {{$data->orderBy('created_at', 'desc')->skip(2)->take(2)->get()->first()->created_at}}
                            </div>
                            <!-- feature_article_date -->
    
                            <div class="feature_article_content">
                                {{$data->orderBy('created_at', 'desc')->skip(2)->take(2)->get()->first()->description}}
                            </div>
                            <!-- feature_article_content -->
    ...
    <div class="category_section mobile">
        <div class="article_title header_purple">
            <h2><a href="#" target="_self">Mobile</a></h2>
        </div>
        <!----article_title------>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="category_article_title">
                        <h2><a href="#" target="_self">Airbnb launches photo-centric app for iPads and Android
                            tablets. </a></h2>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <h3 class="media-heading"><a href="#" target="_self">Apple launches photo-centric
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <h3 class="media-heading"><a href="#" target="_self">The Portable Charger or data
                                cable</a></h3>
                            <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a href="#">Eric joan</a></span>
                ...
                <div class="col-md-6">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <h3 class="media-heading"><a href="#" target="_self">Iphone 6 launches white & Grey
                                colors handset</a></h3>
                            <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a href="#">Eric joan</a></span>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <h3 class="media-heading"><a href="#" target="_self">Fully new look slim handset
                                like</a></h3>
                            <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a href="#">Eric joan</a></span>
    ...
    <div class="category_section tablet">
        <div class="article_title header_pink">
            <h2><a href="#" target="_self">Tablet Pc</a></h2>
        </div>
        <!-- Mobile News Section -->
                ...
                <div class="col-md-6">
                    <div class="category_article_body">
                        ...
                        <div class="media_social" style="display: flex;margin-bottom:10px">
                            <span><a href="#"><i class="fa fa-share-alt"></i>424 </a> Shares</span>
                            <span><i class="fa fa-comments-o"></i><a href="#">4</a> Comments</span>
                            <form action="{{ route('admindelete') }}" method="POST" style="margin-top: -5px">
                                @csrf
                                <input type="hidden" name="id" value="{{ $data->id }}">
                                <button class="btn btn-danger">delete</button>
                            </form>
                            <a href="{{route('adminedit',["id"=>$data->id])}}" class="btn btn-warning" style="margin-top: -5px;margin-left:5px">edit</a>
    ...
    <div class="category_section gadget">
        <div class="article_title header_black">
            <h2><a href="#" target="_self">Gadgets</a></h2>
        </div>
        <div class="category_article_wrapper">
            <div class="row">
                <div class="col-md-6">
                    <div class="category_article_body">
                        ...
                        <span class="tag black"><a href="#" target="_self">Gadgets</a></span>
    
                        <div class="category_article_title">
                            <h2><a href="#" target="_self">A good news for gadget users Ds tech comming soon</a>
                            </h2>
                        </div>
                        <!-- category_article_title -->
                ...
                <div class="col-md-6">
                    <div class="category_article_body">
                        ...
                        <div class="category_article_title">
                            <h2><a href="#" target="_self">Apple launches photo-centric app for iPads and Android
                                tablets</a></h2>
                        </div>
                        <!-- category_article_title -->
    ...
    <div class="category_section camera">
        <div class="article_title header_orange">
            <h2><a href="#" target="_self">Camera</a></h2>
        </div>
        <!-- article_title -->
        ...
        <div class="category_article_wrapper">
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <div class="category_article_title">
                        <h2><a href="#" target="_self">Yasaki camera launches new generic hi-speed </a></h2>
                    </div>
                    <!-- category_article_title -->
        ...
        <div class="category_article_wrapper">
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <div class="category_article_title">
                        <h2><a href="#" target="_self">DSLR is the most old camera at this time </a></h2>
                    </div>
                    <!-- category_article_title -->
        ...
        <div class="category_article_wrapper">
            <div class="row">
                ...
                <div class="col-md-7">
                    <span class="tag orange"><a href="#" target="_self">Camera</a></span>
    
                    <div class="category_article_title">
                        <h2><a href="#" target="_self">Canon Camera launches photo centric Android</a></h2>
                    </div>
                    <!-- category_article_title -->
    ...
    <div class="category_section design">
        <div class="article_title header_blue">
            <h2><a href="#" target="_self">Design</a></h2>
        </div>
        <!-- row -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="category_article_body">
                        ...
                        <span class="tag blue"><a href="#" target="_self">Design</a></span>
    
                        <div class="category_article_title">
                            <h2><a href="#" target="_self">Marketing Tranportation Fast and </a></h2>
                        </div>
                        <!-- category_article_title -->
                ...
                <div class="col-md-6">
                    <div class="category_article_body">
                        ...
                        <div class="category_article_title">
                            <h2><a href="#" target="_self">Theme Hippo launches Unship </a></h2>
                        </div>
                        <!-- category_article_title -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="category_article_body">
                        ...
                        <div class="category_article_title">
                            <h2><a href="#" target="_self">Huge Ultimate website builder </a></h2>
                        </div>
                        <!-- category_article_title -->
                ...
                <div class="col-md-6">
                    <div class="category_article_body">
                        ...
                        <div class="category_article_title">
                            <h2><a href="#" target="_self">Just another theme xdesign</a></h2>
                        </div>
                        <!-- category_article_title -->
    ...
    <div class="widget">
        ...
        <div class="media">
            ...
            <div class="media-body">
                <h3 class="media-heading">
                    <a href="#" target="_self">Canon launches photo centric 00214 Model supper shutter camera</a>
        ...
        <div class="media">
            ...
            <div class="media-body">
                <h3 class="media-heading">
                    <a href="#" target="_self">Samsung galaxy note are the supper mobile of all products.</a>
                </h3>
                <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a href="#">Eric joan</a></span>
        ...
        <div class="media">
            ...
            <div class="media-body">
                <h3 class="media-heading">
                    <a href="#" target="_self">Kodak Hi-Speed shutter double shot camera comming soon</a>
                </h3>
                <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a href="#">Eric joan</a></span>
    ...
    <div class="widget m30">
        ...
        <div class="media">
            ...
            <div class="media-body">
                <h3 class="media-heading">
                    <a href="#" target="_self">Samsung is the best mobile in the android market.</a>
                </h3>
    ...
    <section id="footer_section" class="footer_section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="footer_widget_title"><h3><a href="#" target="_self">About Tech</a></h3></div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h3 class="media-heading">
                                <a href="#">Apple launches photo-centric wrist watch for Android</a>
                            </h3> 
                            <span class="rating">
                                <i class="fa fa-star"></i> 
                                <i class="fa fa-star"></i> 
