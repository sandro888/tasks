...
class PostsController extends Controller
{
    ...
    public function addToCart(Request $request){
        return "Your product was almost placed in a cart but sandro forgot to save user in session storage and time went fly...";
        ...
        //   $cart = new cart;
        //   $cart->prodcut_id=$request -> Posts::where("id",$request->input("id"));
        //   $cart->save();
    }
}
